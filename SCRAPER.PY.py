...
for a in range(4):
    ...
    page=requests.get("https://www.etreproprio.com/annonces/thflcpo.lc29019-r0.odd.g"+str(a)+"#list")
...
for k in range(4):
    ...
    page1=requests.get("https://www.etreproprio.com/annonces/thflcpo.lc63113-r0.odd.g"+str(k)+"#list")
    soup1=BeautifulSoup(page1.content, 'html.parser')
...
for k_ in range(4):
    ...
    page1_=requests.get("https://www.etreproprio.com/annonces/thflcpo.lc06088-r0.odd.g"+str(k_)+"#list")
...
df.to_csv("annoncesimmo.csv", index=False, encoding="utf-8")

print("Fichier CSV créé ici :annoncesimmo.csv")
